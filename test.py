...
if __name__ == '__main__':
    ...
    newKnnClassifier =knn_classifier_for_static_data(matrix_4x4,matrix_4x1,matrix_3x4,matrix_3x1,5)
    ...
    for i in range(len(the_choice)):        
        ...
        for i in range(error3.shape[0]):
            error3[i] = error_rate(matrix_4x4,matrix_4x1,np.round(list_4x2[0][:,i]),opts=opts)
